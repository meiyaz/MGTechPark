...
const About = () => (
  <Section id="about">
    <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
      <div className="w-full h-80 md:h-96 bg-gray-200 rounded-lg shadow-lg flex items-center justify-center">
        <span className="text-gray-500 text-lg">Our Team</span>
      </div>
      <div className="mt-8 md:mt-0">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">About MG Tech Park</h2>
